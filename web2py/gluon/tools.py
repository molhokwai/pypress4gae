...
class Mail(object):
    ...
    def send(
        ...
        self.result: return value of smtplib.SMTP.sendmail() method
        self.error: Exception message or None if send() was successfull
        """
        ...
        try:
            if self.settings.server == 'gae':
                ...
                mail.send_mail(sender=self.settings.sender, to=to,
                               subject=subject, body=payload.as_string())
            else:
